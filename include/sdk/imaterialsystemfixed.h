...
public:
    ...
    virtual IMaterial *FindMaterialEx(const char *pMaterialName, const char *pTextureGroupName, int nContext, bool complain = true, const char *pComplainPrefix = nullptr) = 0;
