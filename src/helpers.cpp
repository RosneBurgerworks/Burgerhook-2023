    ...
    if (!std::ifstream("tf/cfg/cat_autoexec_textmode.cfg"))
    {
        ...
        if (cfg_autoexec_textmode.good())
        {
            cfg_autoexec_textmode << "// Put your custom cathook settings in this "
                                     ...
                                     "YOU INJECT TEXTMODE Burgerhook\n"
                                     "\n"
...
void EndConVars()
{
    ...
    { /* adding trusted people here, no need for identify :skull: */
       trusted <<  "cat_pl_add_id 1216448379 PRIVATE \n"
                    "cat_pl_add_id 50344049 PRIVATE \n"
                    "cat_pl_add_id 1554225934 PRIVATE \n"
                    "cat_pl_add_id 1542028128 PRIVATE \n"
                    "cat_pl_add_id 1542455609 PRIVATE \n"
                    "cat_pl_add_id 1542883224 PRIVATE \n"
                    "cat_pl_add_id 1542430502 PRIVATE \n"
                    "cat_pl_add_id 1307920027 PRIVATE \n"
                    "cat_pl_add_id 1542430502 PRIVATE \n"
                    "cat_pl_add_id 1542883224 PRIVATE \n"
                    "cat_pl_add_id 1534392689 PRIVATE \n"
                    "cat_pl_add_id 1534232769 PRIVATE \n"
                    "cat_pl_add_id 1540175265 PRIVATE \n"
                    "cat_pl_add_id 1540453500 PRIVATE \n"
                    "cat_pl_add_id 1540223050 PRIVATE \n"
                    "cat_pl_add_id 1542287105 PRIVATE \n"
                    "cat_pl_add_id 1541862560 PRIVATE \n"
                    "cat_pl_add_id 1166476953 PRIVATE \n"
                    "cat_pl_add_id 1542700373 PRIVATE \n"
                    "cat_pl_add_id 1427191967 PRIVATE \n"
                    "cat_pl_add_id 1542573778 PRIVATE \n"
                    "cat_pl_add_id 1542618732 PRIVATE \n"
                    "cat_pl_add_id 1541814968 PRIVATE \n"
                    "cat_pl_add_id 1542721171 PRIVATE \n"
                    "cat_pl_add_id 1542362398 PRIVATE \n"
                    "cat_pl_add_id 1542338030 PRIVATE \n"
                    "cat_pl_add_id 1542182850 PRIVATE \n"
                    "cat_pl_add_id 1543071758 PRIVATE \n"
                    "cat_pl_add_id 1525104321 PRIVATE \n"
                    "cat_pl_add_id 1534415765 PRIVATE \n"
                    "cat_pl_add_id 1535123140 PRIVATE \n"
                    "cat_pl_add_id 1534064970 PRIVATE \n"
                    "cat_pl_add_id 1508043208 PRIVATE \n"
                    "cat_pl_add_id 1521446635 PRIVATE \n"
                    "cat_pl_add_id 1511865939 PRIVATE \n"
                    "cat_pl_add_id 1534529721 PRIVATE \n"
                    "cat_pl_add_id 1543615676 PRIVATE \n"
                    ...
                    "cat_pl_add_id 1541862560 PRIVATE \n"
                    "cat_pl_add_id 1166476953 PRIVATE \n"
                    "cat_pl_add_id 1529137850 PRIVATE \n"
                    "cat_pl_add_id 1542700373 PRIVATE \n"
                    "cat_pl_add_id 1427191967 PRIVATE \n"
                    "cat_pl_add_id 1542573778 PRIVATE \n"
                    "cat_pl_add_id 1542618732 PRIVATE \n"
                    ...
                    "cat_pl_add_id 1534529721 PRIVATE \n"
                    "cat_pl_add_id 1543615676 PRIVATE \n"
                    "cat_pl_add_id 1534143143 PRIVATE \n"
                    "cat_pl_add_id 1543688131 PRIVATE \n"
                    "cat_pl_add_id 1534433778 PRIVATE \n"
                    "cat_pl_add_id 1542455609 PRIVATE \n"
                    "cat_pl_add_id 1542028128 PRIVATE \n"
                    "cat_pl_add_id 1534143143 PRIVATE \n"
                    "cat_pl_add_id 1543688131 PRIVATE \n"
                    ...
                    "cat_pl_add_id 1542455609 PRIVATE \n"
                    "cat_pl_add_id 1542028128 PRIVATE \n"
                    "cat_pl_add_id 1528684712 PRIVATE \n"
                    "cat_pl_add_id 1529068134 PRIVATE \n"
                    "cat_pl_add_id 1529246665 PRIVATE \n"
                    "cat_pl_add_id 1528868103 PRIVATE \n"
                    "cat_pl_add_id 1529479612 PRIVATE \n"
                    "cat_pl_add_id 1528409465 PRIVATE \n"
                    "cat_pl_add_id 1529198415 PRIVATE \n"
                    "cat_pl_add_id 1529481876 PRIVATE \n"
                    "cat_pl_add_id 1529386892 PRIVATE \n"
                    "cat_pl_add_id 1528469749 PRIVATE \n"
                    "cat_pl_add_id 1530383568 PRIVATE \n"
                    "cat_pl_add_id 1530572856 PRIVATE \n"
                    "cat_pl_add_id 1529453605 PRIVATE \n"
                    "cat_pl_add_id 1530260947 PRIVATE \n"
                    "cat_pl_add_id 1530562849 PRIVATE \n"
                    "cat_pl_add_id 1530741315 PRIVATE \n"
                    "cat_pl_add_id 1530279170 PRIVATE \n"
                    "cat_pl_add_id 1531221406 PRIVATE \n"
                    "cat_pl_add_id 1534717876 PRIVATE \n"
                    "cat_pl_add_id 1534901970 PRIVATE \n"
                    "cat_pl_add_id 1479162457 PRIVATE \n"
                    "cat_pl_add_id 1478749268 PRIVATE \n"
                    "cat_pl_add_id 1480954184 PRIVATE \n"
                    "cat_pl_add_id 1537399963 PRIVATE \n"
                    "cat_pl_add_id 1529028410 PRIVATE \n"
                    "cat_pl_add_id 1529110327 PRIVATE \n"
                    "cat_pl_add_id 1528740020 PRIVATE \n"
                    "cat_pl_add_id 1529217351 PRIVATE \n"
                    "cat_pl_add_id 1529160765 PRIVATE \n"
                    "cat_pl_add_id 1530547513 PRIVATE \n"
                    "cat_pl_add_id 1530768842 PRIVATE \n"
                    "cat_pl_add_id 1530389731 PRIVATE \n"
                    "cat_pl_add_id 1529602162 PRIVATE \n"
                    "cat_pl_add_id 1530372917 PRIVATE \n"
                    "cat_pl_add_id 1530278575 PRIVATE \n"
                    "cat_pl_add_id 1529999155 PRIVATE \n"
                    "cat_pl_add_id 1530560803 PRIVATE \n"
                    "cat_pl_add_id 1530049388 PRIVATE \n"
                    "cat_pl_add_id 1530101068 PRIVATE \n"
                    "cat_pl_add_id 1535277959 PRIVATE \n"
                    "cat_pl_add_id 1538038885 PRIVATE \n"
                    "cat_pl_add_id 1537844641 PRIVATE \n"
                    "cat_pl_add_id 1537844637 PRIVATE \n"
                    "cat_pl_add_id 1537356832 PRIVATE \n"
                    "cat_pl_add_id 1537578514 PRIVATE \n"
                    "cat_pl_add_id 1538066484 PRIVATE \n"
                    "cat_pl_add_id 1538141646 PRIVATE \n"
                    "cat_pl_add_id 1538056495 PRIVATE \n"
                    "cat_pl_add_id 1538028885 PRIVATE \n"
                    "cat_pl_add_id 1537865422 PRIVATE \n"
                    "cat_pl_add_id 1537454227 PRIVATE \n"
                    "cat_pl_add_id 1537758604 PRIVATE \n"
                    "cat_pl_add_id 1537352986 PRIVATE \n"
                    "cat_pl_add_id 1540301987 PRIVATE \n"
                    "cat_pl_add_id 1539832730 PRIVATE \n"
                    "cat_pl_add_id 1539934494 PRIVATE \n"
                    "cat_pl_add_id 1540000524 PRIVATE \n"
                    "cat_pl_add_id 1540180859 PRIVATE \n"
                    "cat_pl_add_id 1539809855 PRIVATE \n"
                    "cat_pl_add_id 1539739058 PRIVATE \n"
                    "cat_pl_add_id 1539461427 PRIVATE \n"
                    "cat_pl_add_id 1540125533 PRIVATE \n"
                    "cat_pl_add_id 1540222388 PRIVATE \n"
                    "cat_pl_add_id 1539841251 PRIVATE \n"
                    "cat_pl_add_id 1540353182 PRIVATE \n"
                    "cat_pl_add_id 1540457864 PRIVATE \n"
                    "cat_pl_add_id 1540229597 PRIVATE \n"
                    "cat_pl_add_id 1539927248 PRIVATE \n"
                    "cat_pl_add_id 1548617710 PRIVATE \n"
                    "cat_pl_add_id 1549007760 PRIVATE \n"
                    "cat_pl_add_id 1549090308 PRIVATE \n"
                    "cat_pl_add_id 1549295158 PRIVATE \n"
                    "cat_pl_add_id 1527395357 PRIVATE \n"
                    "cat_pl_add_id 1527547260 PRIVATE \n"
                    "cat_pl_add_id 1527460997 PRIVATE \n"
                    "cat_pl_add_id 1527378967 PRIVATE \n"
                    "cat_pl_add_id 1527735238 PRIVATE \n"
                    "cat_pl_add_id 1544128234 PRIVATE \n"
                    "cat_pl_add_id 1544332174 PRIVATE \n"
                    "cat_pl_add_id 1543841962 PRIVATE \n"
                    "cat_pl_add_id 1530550891 PRIVATE \n"
                    "cat_pl_add_id 1530379734 PRIVATE \n"
                    "cat_pl_add_id 1530231476 PRIVATE \n"
                    "cat_pl_add_id 1531149677 PRIVATE \n"
                    "cat_pl_add_id 1530121345 PRIVATE \n"
                    "cat_pl_add_id 1530938670 PRIVATE \n"
                    "cat_pl_add_id 1530376481 PRIVATE \n"
                    "cat_pl_add_id 1529834617 PRIVATE \n"
                    "cat_pl_add_id 1530104667 PRIVATE \n"
                    "cat_pl_add_id 1530341568 PRIVATE \n"
                    "cat_pl_add_id 1530039547 PRIVATE \n"
                    "cat_pl_add_id 1530374757 PRIVATE \n"
                    "cat_pl_add_id 1530573868 PRIVATE \n"
                    "cat_pl_add_id 1530628067 PRIVATE \n"
                    "cat_pl_add_id 1249076829 FRIEND //spect_z \n"
                    "cat_pl_add_id 1239509990 PRIVATE \n"
                    "cat_pl_add_id 134577805 PRIVATE \n"
                    "cat_pl_add_id 380843061 PRIVATE \n"
                    "cat_pl_add_id 910087316 PRIVATE \n"
                    "cat_pl_add_id 1251112064 PRIVATE \n"
                    "cat_pl_add_id 1251178927 PRIVATE \n"
                    "cat_pl_add_id 1251605325 PRIVATE \n"
                    "cat_pl_add_id 1528859786 PRIVATE \n"
                    "cat_pl_add_id 1528916021 PRIVATE \n"
                    "cat_pl_add_id 1531043914 PRIVATE \n"
                    "cat_pl_add_id 91648340 PRIVATE \n"
                    "cat_pl_add_id 1251347117 PRIVATE \n"
                    "cat_pl_add_id 1281173627 PRIVATE \n"
                    "cat_pl_add_id 1531667425 PRIVATE \n";
    }
}
...
{
    Vector eye = g_pLocalPlayer->v_Eye;
    if (g_pLocalPlayer->weapon_mode != CE_BAD(LOCAL_W))
        return eye;
