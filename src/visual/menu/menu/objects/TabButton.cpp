...
static settings::RVariable<rgba_t> color_selected{ "zk.style.tab-button.color.selected.background", "0000005e" };
static settings::RVariable<rgba_t> color_separator{ "zk.style.tab-button.color.separator", "000000ff" };
static settings::RVariable<rgba_t> color_hover_underline{ "zk.style.tab-button.color.hover.underline", "ff8800ff" };
static settings::RVariable<rgba_t> color_selected_underline{ "zk.style.tab-button.color.selected.underline", "ff8800ff" };
